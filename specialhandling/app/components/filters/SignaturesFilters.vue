    ...
    <div class="search-form">
        <div class="row mx-0">
            ...
            <select-single id="selectInstructions" class="col-6 col-sm-4 col-lg-3" label="Instructions" 
                           placeholder="" :options="options.instructions" v-model="filters.instructions.filter">
            </select-single>
            <text-box id="selectEdocNumber" class="col-6 col-sm-4 col-lg-2" label="Edoc #"
                      v-model="filters.edoc_number.filter" placeholder="XXXXXXX">
            </text-box>
            <text-box id="selectOrgCode" class="col-4 col-sm-4 col-lg-2" label="Org Code"
                      v-model="filters.org_code.filter" placeholder="XXXX">
            </text-box>
            <text-box id="selectContactName" class="col-4 col-sm-4 col-lg-2" label="Contact Name"
